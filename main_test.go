...
func TestCalcPreviousPeriod_Week(t *testing.T) {
	tests := []struct {
		name          string
		startDate     time.Time
		endDate       time.Time
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotStart, gotEnd := calcPreviousPeriod(tt.startDate, tt.endDate, prompt.PeriodTypeWeek)
...
func TestCalcPreviousPeriod_Month(t *testing.T) {
	tests := []struct {
		name          string
		startDate     time.Time
		endDate       time.Time
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotStart, gotEnd := calcPreviousPeriod(tt.startDate, tt.endDate, prompt.PeriodTypeMonth)
			if !gotStart.Equal(tt.wantPrevStart) {
				t.Errorf("prevStartDate: got %v, want %v", gotStart, tt.wantPrevStart)
			}
			if !gotEnd.Equal(tt.wantPrevEnd) {
...
func TestCalcPreviousPeriod_Custom(t *testing.T) {
	tests := []struct {
		name          string
		startDate     time.Time
		endDate       time.Time
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotStart, gotEnd := calcPreviousPeriod(tt.startDate, tt.endDate, prompt.PeriodTypeCustom)
			if !gotStart.Equal(tt.wantPrevStart) {
				t.Errorf("prevStartDate: got %v, want %v", gotStart, tt.wantPrevStart)
			}
			if !gotEnd.Equal(tt.wantPrevEnd) {
